...
const Refunds = () => {
  useEffect(() => {
    document.title = "Refunds | Traditional Me";
  }, []);
  return (
    <main className="terms">
      ...
      <p>
        ...
        requesting a refund for the growth services provided by Traditional Me
        ("Traditional Me," "we," "our," or "us"). By using our services, you

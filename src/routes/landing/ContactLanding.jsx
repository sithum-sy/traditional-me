    ...
    <article className="section-10  flex-container flex-column">
      ...
      >
        ...
        <section>
          ...
          <ul>
            <li>- Email: support@traditionalme.com</li>
            <li>- Phone: +94 11 2265125</li>
            <li>- Hours: Monday - Saturday, 6:00am - 9:00pm (EST)</li>
          </ul>
        </section>
        <section>
          ...
          <ul>
            <li>- Email: info@traditionalme.com</li>
          </ul>
        </section>
        <section>
          ...
          <ul>
            <li>- Email: feedback@traditionalme.com</li>
          </ul>
        </section>
      </motion.div>
    </article>
